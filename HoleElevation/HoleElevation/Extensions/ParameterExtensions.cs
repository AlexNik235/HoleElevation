namespace HoleElevation.Extensions
{
    ...
    public static class ParameterExtensions
    {
        ...
        /// <param name="foundParameter">Параметр Revit</param>
        /// <param name="digits">Количество цифр дробной части в возвращаемом значении</param>
        /// <returns>Значение параметра</returns>
        public static T GetParameterValue<T>(this Parameter foundParameter, int digits = 4)
        {
            try
            {
                ...
                var value = foundParameter.GetParameterValue(digits);
